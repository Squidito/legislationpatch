...
const ACRONYMS = {
  ...
  CTR:   'Cooperative Threat Reduction (DOD threat-reduction program)',
  ENDS:  'Electronic Nicotine Delivery Systems (e-cigarettes)',
  ...
  CJS:   'Commerce, Justice, Science, and Related Agencies (appropriations subcommittee)',
  FSGG:  'Financial Services and General Government (appropriations subcommittee)',
  ...
  NSIP:   'National Security Investment Programs',
  WSP:    'Worldwide Security Protection',
  SFOPS:  'State, Foreign Operations, and Related Programs Appropriations Act',
  ICJ:    'International Court of Justice',
  ICC:    'International Criminal Court',
  IRGC:   'Islamic Revolutionary Guard Corps',
  JCPOA:  'Joint Comprehensive Plan of Action (Iran nuclear agreement)',
  OIG:    'Office of Inspector General',
  GEF:    'Global Environment Facility',
  EBRD:   'European Bank for Reconstruction and Development',
  BUILD:  'Better Utilization of Investments Leading to Development Act',
  // Financial / oversight
