...
async function fetchRecentBills() {
  // Gemini 3.1 work: Removed live Congress.gov API fetching logic. 
  // The app now solely relies on static data/cache.json generated by a nightly batch process.
  try {
...
// Gemini 3.1 work: Removed live Anthropic API calls. Analysis is now run during the static batch process.
